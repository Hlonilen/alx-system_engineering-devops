...
This is a distributed web architecture that tries to decrease traffic to the primary server by spreading some of the load to a replica server with the help of a server that balances the load between the two servers (primary and replica).
